...
import { PublicRecipeService } from '../../services/recipe/public-recipe.service';
import { Recipe } from '../../services/recipe/recipe.service';
import { RecipeType } from '../recipes/recipes.component';
...
@Component({
  ...
  styleUrl: './public-recipes.component.scss',
})
export class PublicRecipesComponent implements OnInit {
  recipesService = inject(PublicRecipeService);
  ...
  slides: SliderItem[] = [
    {
      ...
      title: 'Pasteles',
      subtitle: 'Deliciosas recetas de pasteles para cada ocasión.',
      label_slide: 'slide 1',
    },
    {
      src: 'https://cdn.pixabay.com/photo/2018/05/01/18/21/eclair-3366430_640.jpg',
      title: 'Postres',
      subtitle: 'Endulza tu día con estas increíbles creaciones.',
      label_slide: 'slide 2',
    },

    {
      ...
      title: 'Carnes',
      subtitle: 'Platos de carne que te harán agua la boca.',
      label_slide: 'slide 3',
    },
    {
      src: 'https://sazondelbueno.s3.amazonaws.com/dc9ec3b5-20b9-4aff-816e-794fa483a54e.jpeg',
      title: 'Recetas Variadas',
      subtitle: 'Explora un mundo de sabores y nuevas ideas.',
      label_slide: 'aws',
    },
  ];
